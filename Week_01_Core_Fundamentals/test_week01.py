...
class TestAverageCalculator:
    ...
    def test_average_with_negative_numbers(self):
        ...
        assert calculate_average([-10, 20]) == 5.0  # TODO  # TODO

    def test_average_decimal_result(self):
        # TODO: choose values whose mean is not a whole number, e.g. [1, 2]
        assert calculate_average([1, 2]) == pytest.approx(  # TODO
            1.5  # TODO  ← use pytest.approx() for decimals
        )
    ...
    def test_average_empty_list_raises_error(self):
        ...
        with pytest.raises(
            ValueError  # TODO: ValueError or another appropriate exception
        ):
            calculate_average([])
...
class TestArrayReversal:
    ...
    def test_reverse_two_elements(self):
        ...
        assert reverse_array([1, 2]) == [2, 1]  # TODO  # TODO
    ...
    def test_reverse_single_element(self):
        ...
        assert reverse_array([1]) == [1]  # TODO  # TODO
    ...
    def test_reverse_does_not_modify_original(self):
        ...
        assert original == [
            ...
            2,
            3,
        ]  # TODO: what should original still equal after the call?
...
class TestLinearSearch:
    ...
    def test_search_returns_first_occurrence(self):
        ...
        assert (
            linear_search([5, 3, 5, 7], 5) == 0  # TODO: e.g. [5, 3, 5, 7], target=5
        )  # TODO
    ...
    def test_search_string_values(self):
        ...
        assert (
            linear_search(
                ["cat", "dog", "fish"],
                "dog",  # TODO: e.g. ["cat", "dog", "fish"], target="dog"
            )
            == 1
        )  # TODO
...
class TestTemperatureConverter:
    ...
    def test_celsius_to_fahrenheit_freezing_point(self):
        # 0°C should equal 32°F — a good known reference point
    ...
    def test_fahrenheit_to_celsius_returns_float(self):
        # the result should always be a float, even for whole-number inputs
